...
- **Android-first**, iOS port in progress: `ios/` was regenerated 2026-07-07
  ...
  `CFBundleLocalizations` (en/cs/de/ru/pl) and `ITSAppUsesNonExemptEncryption=false`
  (no custom crypto — skips export-compliance questions on upload). Launch screen
