...
void main() {
  group('zoneBands', () {
    ...
    test(
      'full four-bound config yields red/amber/green/amber/red spanning',
      () {
        const b = ZoneBounds(
          amberLow: 7,
          greenLow: 7.5,
    ...
    test(
      'green falls back to chart edges only when no amber bound on that side',
      () {
    ...
    test(
      'amber-only bounds paint green between them, matching classify (#30)',
      () {
